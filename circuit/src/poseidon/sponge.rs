...
use halo2wrong::halo2::circuit::Region;
use halo2wrong::halo2::circuit::Value;
use halo2wrong::halo2::plonk::Advice;
use halo2wrong::halo2::plonk::ConstraintSystem;
use halo2wrong::halo2::plonk::Expression;
use halo2wrong::halo2::plonk::{Column, Selector};
use halo2wrong::halo2::poly::Rotation;
use halo2wrong::halo2::{arithmetic::FieldExt, circuit::AssignedCell, plonk::Error};
    ...
    fn load_state(
        ...
        for i in 0..WIDTH {
			if let Some(cell) = prev_state.get(i) {
				...
				state[i] = Some(region.assign_advice(|| "state", columns[i], round, || Value::known(F::zero()))?);
			}
        }
