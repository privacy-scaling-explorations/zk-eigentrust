//! # EigenTrust Library
//!
//! Provides the `Client` struct to interface with the EigenTrust algorithm's circuits.
//! Additional modules are included to enhance functionality and support integration.
