...
```bash
cargo run --release -- scores
cargo run --release -- update --band-id 38922764296632428858395574229367 --band-th 500
cargo run --release -- bandada --action add --ic 82918723982 --addr 0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266
```
